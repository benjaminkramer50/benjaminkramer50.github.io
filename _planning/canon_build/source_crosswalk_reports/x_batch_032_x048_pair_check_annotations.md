...
- Regenerated `canon_replacement_candidates.tsv` with 1,215 blocked rows.

Check summaries:

| Check field | Status | Rows |
|---|---|---:|
| `duplicate_check` | `cut_generic_duplicate_cluster_review_required` | 625 |
...
| `chronology_check` | `pending_path_position_chronology_validation` | 1,045 |
| `boundary_check` | `cut_boundary_flag_review_required` | 55 |
| `boundary_check` | `add_boundary_clear_cut_not_flagged` | 1,160 |
