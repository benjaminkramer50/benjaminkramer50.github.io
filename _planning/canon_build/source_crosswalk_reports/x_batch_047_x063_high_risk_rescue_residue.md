...
- Reconciled 15 high-risk current rescue-scope rows.
- 15 high-risk rows still map to current existing-source rescue actions.

Residue status summary:

| Status | Rows |
|---|---:|
| `current_high_risk_scope_blocker` | 15 |
...
|---|---:|---|
| `work_candidate_global_lit_burning_plain` | 1 | manual_scope_resolution_required |
| `work_candidate_latcarib_lit_book_sand` | 3 | manual_scope_resolution_required |
