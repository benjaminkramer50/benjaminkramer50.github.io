...
- Reconciled 20 high-risk X061 rows.
- 18 high-risk rows still map to current existing-source rescue actions.
...
| `creator_exact_form_mismatch` | 1 |
| `named_collection_membership_unverified` | 13 |
...
| `work_candidate_latcarib_lit_all_fires_fire` | 3 | find_exact_named_collection_membership_or_reject_source_item_for_cut_side_support |
| `work_candidate_latcarib_lit_blow_up` | 3 | find_exact_named_collection_membership_or_reject_source_item_for_cut_side_support |
