...
- Generated 48 current action rows from the post-X058 X051 queue.
...
| `x059_cut_action_0007` | Collected Poems 1948-1984 | Derek Walcott | `existing_source_item_rescue_review` | `route_source_items_to_scope_review_before_evidence_generation` |
| `x059_cut_action_0008` | Collected Poems | Primo Levi | `existing_source_item_rescue_review` | `route_source_items_to_scope_review_before_evidence_generation` |
| `x059_cut_action_0009` | Selected Poems | Nazim Hikmet | `existing_source_item_rescue_review` | `route_source_items_to_scope_review_before_evidence_generation` |
| `x059_cut_action_0010` | Selected Stories | Felisberto Hernandez | `existing_source_item_rescue_review` | `route_source_items_to_scope_review_before_evidence_generation` |
| `x059_cut_action_0011` | Selected Poems | Elicura Chihuailaf | `existing_source_item_rescue_review` | `route_source_items_to_scope_review_before_evidence_generation` |
| `x059_cut_action_0012` | Poems | Alcman | `external_source_acquisition` | `create_source_acquisition_query` |
