...
- Public rows: `5133`.
- Creator coverage: `3036 / 5133`.
- Chronology coverage: `1936 / 5133` public rows have non-`Unplaced` chronology (`46` reviewed canon records, `19` title overrides, `1631` Wikidata overlay rows, `240` manual metadata corrections).
- Remaining chronology backlog: `3197` public rows marked `Unplaced`.
