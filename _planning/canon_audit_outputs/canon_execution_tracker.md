...
| Phase S4 | Evidence policy and source weighting | Started | Source weights and source-debt rules exist; X017 generated 9 provisional policy-aware evidence rows; scoring not integrated |
...
| X Batch 3 | X013, X014, X015, X016, X017, X018, X019 | Started | X013 candidate rows and X017 provisional evidence/rules created; remaining work is source-debt status reporting, source-container policy, omission queue, and replacement candidates |
