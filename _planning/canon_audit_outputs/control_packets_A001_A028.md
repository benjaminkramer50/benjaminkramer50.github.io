...
| A004 | WARN | Title normalization and article stripping | 40 normalized duplicate/alias candidate keys |
| A005 | WARN | Creator normalization and traditional labels | 0 rows have empty creators; traditional labels still need review |
| A006 | WARN | Alias coverage for translated titles and spellings | 2756 rows have no aliases |
...
| A012 | WARN | Placeholder date and approximate chronology audit | 178 rows have approximate/pending date labels |
...
| A016 | WARN | Tier drift audit | core=218, major=2509, contextual=273 |
...
| A021 | WARN | Duplicate candidate audit by title only | 40 candidate keys |
| A022 | WARN | Duplicate candidate audit by title plus creator | Needs second-stage review; raw duplicate report emitted |
| A023 | WARN | Duplicate candidate audit by alias | 40 alias/title candidate keys |
| A024 | WARN | Duplicate candidate audit by translated/original title | Depends on fuller alias metadata |
| A025 | WARN | Boundary-note missingness audit | 448 boundary-sensitive rows need explicit notes |
