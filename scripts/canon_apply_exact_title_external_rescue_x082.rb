...
APPLIED_PATH = File.join(TABLE_DIR, "canon_external_source_rescue_evidence_applied_x082.tsv")
...
REPORT_PATH = File.join(REPORT_DIR, "x_batch_066_x082_exact_title_external_rescue.md")
...
TARGETS = [
  {
    work_id: "work_candidate_wave003_louise_labe_sonnets_elegies",
    title: "Sonnets et elegies",
    creator: "Louise Labe",
    raw_date: "1555",
    form_note: "French Renaissance sonnet and elegy collection",
    rationale: "Google Books and Encyclopedia.com support Labe's sonnets-and-elegies corpus; the local source items are individual sonnets/elegies, so this packet uses external complete-title support rather than component rows.",
    sources: [
      ["x082_google_books_labe_sonnets_elegies", "Google Books: Elegies et sonnets", "publisher_reference_series", "Google Books, Elegies et sonnets by Louise Labe, https://books.google.com/books/about/%C3%89l%C3%A9gies_i_e_et_sonnets.html?id=gtB72UbukDsC", "Google Books title record", "https://books.google.com/books/about/%C3%89l%C3%A9gies_i_e_et_sonnets.html?id=gtB72UbukDsC", "x082_google_books_exact_labe_sonnets_elegies", "0.55", "publisher_record_support_for_labe_sonnets_elegies"],
      ["x082_encyclopedia_labe_sonnets_elegies", "Encyclopedia.com: Louise Labe", "reference_encyclopedia", "Encyclopedia.com, Labe, Louise (1520-1566), https://www.encyclopedia.com/arts/arts-construction-medicine-science-and-technology-magazines/labe-louise-1520-1566", "Reference biography", "https://www.encyclopedia.com/arts/arts-construction-medicine-science-and-technology-magazines/labe-louise-1520-1566", "x082_encyclopedia_exact_labe_sonnets_elegies", "0.55", "reference_support_for_labe_sonnets_elegies"]
    ]
  },
  {
    work_id: "work_candidate_bloom_gap_031_0278_les_odes",
    title: "Les Odes",
    creator: "Pierre de Ronsard",
    raw_date: "1550-1552",
    form_note: "French Renaissance ode collection",
    rationale: "Britannica and Larousse independently identify Ronsard's Odes/Les Odes as the work row's target collection rather than a generic selected-poems placeholder.",
    sources: [
      ["x082_britannica_ronsard_odes", "Britannica: Odes by Ronsard", "reference_encyclopedia", "Britannica, Odes by Pierre de Ronsard, https://www.britannica.com/topic/Odes-poems-by-Ronsard", "Britannica work entry", "https://www.britannica.com/topic/Odes-poems-by-Ronsard", "x082_britannica_exact_ronsard_odes", "0.55", "reference_support_for_ronsard_odes"],
      ["x082_larousse_ronsard_odes", "Larousse: Odes", "reference_encyclopedia", "Larousse, Odes, https://www.larousse.fr/encyclopedie/oeuvre/Odes/126937", "Larousse work entry", "https://www.larousse.fr/encyclopedie/oeuvre/Odes/126937", "x082_larousse_exact_ronsard_odes", "0.55", "reference_support_for_ronsard_odes"]
    ]
  },
  {
    work_id: "work_candidate_wave003_swinburne_poems_ballads",
    title: "Poems and Ballads",
    creator: "Algernon Charles Swinburne",
    raw_date: "1866",
    form_note: "Victorian English poetry collection",
    rationale: "Britannica and the Poetry Foundation both support Poems and Ballads as Swinburne's 1866 collection and the work that established his reputation and controversy.",
    sources: [
      ["x082_britannica_swinburne_poems_ballads", "Britannica: Algernon Charles Swinburne", "reference_encyclopedia", "Britannica, Algernon Charles Swinburne, https://www.britannica.com/biography/Algernon-Charles-Swinburne", "Britannica author biography", "https://www.britannica.com/biography/Algernon-Charles-Swinburne", "x082_britannica_exact_swinburne_poems_ballads", "0.55", "reference_support_for_swinburne_poems_ballads"],
      ["x082_poetry_foundation_swinburne_poems_ballads", "Poetry Foundation: Algernon Charles Swinburne", "language_literary_history", "Poetry Foundation, Algernon Charles Swinburne, https://www.poetryfoundation.org/poets/algernon-charles-swinburne", "Poet profile", "https://www.poetryfoundation.org/poets/algernon-charles-swinburne", "x082_poetry_foundation_exact_swinburne_poems_ballads", "0.55", "literary_history_support_for_swinburne_poems_ballads"]
    ]
  },
  {
    work_id: "work_candidate_wave003_hopkins_poems",
    title: "Poems of Gerard Manley Hopkins",
    creator: "Gerard Manley Hopkins",
    raw_date: "1918",
    form_note: "Posthumous English poetry collection",
    rationale: "Britannica and Google Books support the 1918 Poems of Gerard Manley Hopkins collection; title policy may later decide whether to display the leading article The.",
    sources: [
      ["x082_britannica_hopkins_poems", "Britannica: Gerard Manley Hopkins", "reference_encyclopedia", "Britannica, Gerard Manley Hopkins, https://www.britannica.com/biography/Gerard-Manley-Hopkins", "Britannica author biography", "https://www.britannica.com/biography/Gerard-Manley-Hopkins", "x082_britannica_exact_hopkins_poems", "0.55", "reference_support_for_hopkins_poems"],
      ["x082_google_books_hopkins_poems", "Google Books: The Poems of Gerard Manley Hopkins", "publisher_reference_series", "Google Books, The Poems of Gerard Manley Hopkins, https://books.google.com/books/about/The_Poems_of_Gerard_Manley_Hopkins.html?id=8N01AAAAMAAJ", "Google Books title record", "https://books.google.com/books/about/The_Poems_of_Gerard_Manley_Hopkins.html?id=8N01AAAAMAAJ", "x082_google_books_exact_hopkins_poems", "0.55", "publisher_record_support_for_hopkins_poems"]
    ]
  },
  {
    work_id: "work_candidate_wave004_zoshchenko_sentimental_tales",
    title: "Sentimental Tales",
    creator: "Mikhail Zoshchenko",
    raw_date: "1923-1929 cycle; English translation 2018",
    form_note: "Russian satirical story cycle",
    rationale: "Columbia University Press and Foreword Reviews both support Sentimental Tales as a Zoshchenko story cycle in English translation; chronology/display review can later separate original cycle dates from translation date.",
    sources: [
      ["x082_cup_zoshchenko_sentimental_tales", "Columbia University Press: Sentimental Tales", "publisher_reference_series", "Columbia University Press, Sentimental Tales by Mikhail Zoshchenko, https://cup.columbia.edu/book/sentimental-tales/9780231183789", "Columbia University Press book page", "https://cup.columbia.edu/book/sentimental-tales/9780231183789", "x082_cup_exact_zoshchenko_sentimental_tales", "0.55", "publisher_support_for_zoshchenko_sentimental_tales"],
      ["x082_foreword_zoshchenko_sentimental_tales", "Foreword Reviews: Sentimental Tales", "prize_or_reception_layer", "Foreword Reviews, Sentimental Tales, https://www.forewordreviews.com/reviews/sentimental-tales/", "Foreword Reviews review", "https://www.forewordreviews.com/reviews/sentimental-tales/", "x082_foreword_exact_zoshchenko_sentimental_tales", "0.55", "review_support_for_zoshchenko_sentimental_tales"]
    ]
  },
  {
    work_id: "work_candidate_wave001_bierce_in_midst_of_life",
    title: "In the Midst of Life",
    creator: "Ambrose Bierce",
    raw_date: "1891; expanded/retitled 1898",
    form_note: "American short story collection",
    rationale: "Britannica and Google Books support In the Midst of Life / Tales of Soldiers and Civilians as Bierce's short-story collection; the row should retain the alternate-title history in later display cleanup.",
    sources: [
      ["x082_britannica_bierce_midst_life", "Britannica: In the Midst of Life", "reference_encyclopedia", "Britannica, In the Midst of Life, https://www.britannica.com/topic/In-the-Midst-of-Life", "Britannica work entry", "https://www.britannica.com/topic/In-the-Midst-of-Life", "x082_britannica_exact_bierce_midst_life", "0.55", "reference_support_for_bierce_midst_life"],
      ["x082_google_books_bierce_midst_life", "Google Books: In the Midst of Life", "publisher_reference_series", "Google Books, In the Midst of Life, https://books.google.com/books/about/In_the_Midst_of_Life.html?id=xJk_AQAAMAAJ", "Google Books title record", "https://books.google.com/books/about/In_the_Midst_of_Life.html?id=xJk_AQAAMAAJ", "x082_google_books_exact_bierce_midst_life", "0.55", "publisher_record_support_for_bierce_midst_life"]
    ]
  }
].freeze
...
def source_item_id(source_id)
  source_id.sub(/\Ax082_/, "x082_item_")
end

def evidence_id(source_id)
  source_id.sub(/\Ax082_/, "x082_ev_")
end
  ...
  TARGETS.flat_map do |target|
    target.fetch(:sources).map do |source|
      source_id, source_title, source_type, citation, = source
      {
        ...
        "extraction_method" => "Targeted X082 exact-title public source review",
  ...
  TARGETS.flat_map do |target|
    target.fetch(:sources).map do |source|
      source_id, _source_title, _source_type, citation, section, url, method, weight, supports = source
      {
        ...
        "notes" => "X082 accepted external exact-title support; no cut or replacement approved."
      }
    end
  end
end
...
def evidence_rows(items)
  items.map do |item|
    weight = item.fetch("evidence_weight").to_f
    {
      ...
      "notes" => "X082 accepted targeted public source support for exact-title source rescue; no public canon replacement approved."
    }
  end
end
...
def update_manifest(applied_rows, source_debt_after, lane_counts, high_risk_rows, new_registry_rows, new_source_items, new_evidence_rows)
  ...
  manifest["status"] = "exact_title_external_rescue_x082_applied"
  artifacts["source_items"] = "e001_ingested_through_x082_exact_title_source_items"
  artifacts["evidence"] = "e001_ingested_policy_aware_rows_through_x082_exact_title_external_support"
  artifacts["source_debt_status"] = "refreshed_after_x082_exact_title_external_rescue"
  artifacts["scoring_inputs"] = "refreshed_after_x082_exact_title_external_rescue"
  artifacts["scores"] = "regenerated_x082_provisional_ready_rows_only"
  artifacts["replacement_candidates"] = "regenerated_after_x082_blocked_add_cut_pairings"
  artifacts["cut_candidates"] = "regenerated_after_x082_all_incumbent_cut_risk_table"
  artifacts["generic_selection_basis_review"] = "regenerated_x051_after_x082_from_cut_review_work_orders"
  artifacts["cut_side_post_x058_action_queue"] = "refreshed_after_x082_from_current_x051"
  artifacts["current_rescue_scope_review"] = "refreshed_x065_after_x082_from_current_x059_existing_source_rescue_lane"
  artifacts["high_risk_rescue_residue"] = "refreshed_x063_after_x082_from_current_x065_high_risk_rows"
  artifacts["external_source_rescue_evidence_applied_x082"] = "generated_x082_for_exact_title_external_acquisition_rows"
  ...
  counts["x082_external_source_rescue_rows"] = applied_rows.size
  counts["x082_target_works_closed"] = TARGETS.count do |target|
    !source_debt_after.fetch(target.fetch(:work_id)).fetch("source_debt_status").start_with?("open_")
  end
  counts["current_high_risk_residue_rows_after_x082"] = high_risk_rows.size

  manifest["exact_title_external_rescue_x082"] = {
    ...
    "target_source_debt_closed_after_refresh" => counts["x082_target_works_closed"],
...
def write_report(applied_rows, source_debt_after, lane_counts, high_risk_rows)
  ...
  File.open(REPORT_PATH, "w") do |file|
    file.puts "# X082 Exact-Title External Rescue"
    file.puts
    file.puts "Status: completed, build-layer only. Public canon path unchanged."
    file.puts
    file.puts "X082 closes exact-title source-debt blockers where at least two independent public support families were available. It deliberately leaves generic selected-poems/stories rows, component-only rows, and thinly sourced exact-title rows for a separate policy pass."
    file.puts
    file.puts "## Target Status"
    file.puts
    file.puts "| Work | Creator | Evidence rows | Source debt after X082 |"
    file.puts "|---|---|---:|---|"
...
applied_rows = new_evidence_rows.map.with_index(1) do |evidence, index|
  ...
  {
    "applied_id" => "x082_external_source_rescue_#{index.to_s.rjust(4, "0")}",
    "work_id" => work_id,
...
update_packet_status(
  {
    ...
    "output_artifact" => [
      "_planning/canon_build/tables/canon_external_source_rescue_evidence_applied_x082.tsv",
      "scripts/canon_apply_exact_title_external_rescue_x082.rb",
      "_planning/canon_build/source_crosswalk_reports/x_batch_066_x082_exact_title_external_rescue.md"
    ].join(";"),
...
puts "applied #{applied_rows.size} X082 exact-title external source evidence rows"
