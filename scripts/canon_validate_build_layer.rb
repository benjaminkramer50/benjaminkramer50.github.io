...
TABLE_FILES = {
  ...
  "external_source_rescue_evidence_applied_x070" => File.join(BUILD_DIR, "tables", "canon_external_source_rescue_evidence_applied_x070.tsv"),
  "external_source_rescue_evidence_applied_x071" => File.join(BUILD_DIR, "tables", "canon_external_source_rescue_evidence_applied_x071.tsv"),
  "title_scope_corrections_x072" => File.join(BUILD_DIR, "tables", "canon_title_scope_corrections_x072.tsv"),
  "external_source_rescue_evidence_applied_x073" => File.join(BUILD_DIR, "tables", "canon_external_source_rescue_evidence_applied_x073.tsv"),
  "external_source_rescue_evidence_applied_x074" => File.join(BUILD_DIR, "tables", "canon_external_source_rescue_evidence_applied_x074.tsv"),
  "external_source_rescue_evidence_applied_x075" => File.join(BUILD_DIR, "tables", "canon_external_source_rescue_evidence_applied_x075.tsv"),
  "external_source_rescue_evidence_applied_x076" => File.join(BUILD_DIR, "tables", "canon_external_source_rescue_evidence_applied_x076.tsv"),
  ...
  "external_source_rescue_evidence_applied_x081" => File.join(BUILD_DIR, "tables", "canon_external_source_rescue_evidence_applied_x081.tsv"),
  "external_source_rescue_evidence_applied_x082" => File.join(BUILD_DIR, "tables", "canon_external_source_rescue_evidence_applied_x082.tsv"),
  "external_source_rescue_evidence_applied_x083" => File.join(BUILD_DIR, "tables", "canon_external_source_rescue_evidence_applied_x083.tsv"),
...
HEADER_REQUIREMENTS = {
  ...
  "external_source_rescue_evidence_applied_x070" => ["applied_id", "work_id", "source_id", "source_item_id", "evidence_id", "source_debt_status_after", "resolution_status", "next_action"],
  "external_source_rescue_evidence_applied_x071" => ["applied_id", "work_id", "source_id", "source_item_id", "evidence_id", "source_debt_status_after", "resolution_status", "next_action"],
  "title_scope_corrections_x072" => ["correction_id", "work_id", "old_title", "corrected_title", "source_debt_status_after", "correction_status", "next_action"],
  "external_source_rescue_evidence_applied_x073" => ["applied_id", "work_id", "source_id", "source_item_id", "evidence_id", "source_debt_status_after", "resolution_status", "next_action"],
  "external_source_rescue_evidence_applied_x074" => ["applied_id", "work_id", "source_id", "source_item_id", "evidence_id", "source_debt_status_after", "resolution_status", "next_action"],
  "external_source_rescue_evidence_applied_x075" => ["applied_id", "work_id", "source_id", "source_item_id", "evidence_id", "source_debt_status_after", "resolution_status", "next_action"],
  "external_source_rescue_evidence_applied_x076" => ["applied_id", "work_id", "source_id", "source_item_id", "evidence_id", "source_debt_status_after", "resolution_status", "next_action"],
  ...
  "external_source_rescue_evidence_applied_x081" => ["applied_id", "work_id", "source_id", "source_item_id", "evidence_id", "source_debt_status_after", "resolution_status", "next_action"],
  "external_source_rescue_evidence_applied_x082" => ["applied_id", "work_id", "source_id", "source_item_id", "evidence_id", "source_debt_status_after", "resolution_status", "next_action"],
  "external_source_rescue_evidence_applied_x083" => ["applied_id", "work_id", "source_id", "source_item_id", "evidence_id", "source_debt_status_after", "resolution_status", "next_action"],
